...
router.get('/:id/versions/:versionNumber', (0, auth_1.requireRoles)('manager', 'admin'), controller.version);
router.get('/:id/versions', (0, auth_1.requireRoles)('manager', 'admin'), controller.versions);
